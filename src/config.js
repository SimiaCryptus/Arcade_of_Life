...
export const CONFIG = {
  ...
  // ── Scoring (overrides for SCORE_VALUES_DEFAULTS) ────────────
  // Each maps to SCORE_VALUES.X — set to override the default.
  SCORE_TARGET_DESTROYED: 1000,
  SCORE_FORTRESS_DESTROYED: 1500,
  SCORE_BUNKER_DESTROYED: 800,
  SCORE_CRUISER_DESTROYED: 1200,
  SCORE_SPAWNER_DESTROYED: 750,
  SCORE_CITY_SURVIVAL_PER_WAVE: 200,
  SCORE_WAVE_CLEAR_BASE: 500,
  SCORE_INK_EFFICIENCY: 0.25,
  SCORE_VICTORY_CITY_BONUS: 1500,
  SCORE_VICTORY_FLAT: 3000,
  SCORE_VICTORY_INK: 1.0,
  SCORE_CITY_CELL_LOST: -50,
  SCORE_FRIENDLY_FIRE_PENALTY: -100,
  SCORE_BREACH_PENALTY: -75,

  // ── Combo system overrides ──────────────────────────────────
